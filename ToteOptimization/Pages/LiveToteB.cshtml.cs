...
{
    public class LiveToteBModel : PageModel
    {
        ...
        private readonly ILogger<LiveToteBModel> _logger;
        private readonly IConfiguration _configuration;
        public LiveToteBModel(ILogger<LiveToteBModel> logger, IConfiguration configuration)
        {
            _logger = logger;
